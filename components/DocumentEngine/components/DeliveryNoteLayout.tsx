...
interface DeliveryNoteLayoutProps {
  config: DocumentConfig;
}

export default function DeliveryNoteLayout({ config }: DeliveryNoteLayoutProps) {
  const { items } = config;
            ...
            {isFirst ? (
              <>
                <DocumentHeader
                  ...
                  variant="full"
                />
                <DocumentCustomerInfo party={config.customer} label="Deliver To" recipient={config.recipient} />
                <DocumentMetadata entries={config.metadata} />
                <DocumentItemsTable items={pageItems} showPrices={config.showPrices} isDeliveryNote />
